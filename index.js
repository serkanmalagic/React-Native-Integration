    ...
    return (
      <View style={styles.container}>
        <Text style={styles.welcome}>
          Şu anki react geliştirme modu ({this.props.buildType})!
        </Text>
        ...
        <View style={styles.buttonContainer}>
          <Button
            ...
            title='İstenen sayfayı aç'
          />
          <Button
            onPress={() => activityStarter.navigateToExampleWithParameter('react nativeden geldim')}
            title='İstenen sayfayı aç parametre ile'
          />
          <Button
